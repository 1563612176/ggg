...
def extract_face(input_file,aligned_output_dir='',unaligned_output_dir='',aligned_image_size=320,zoom_in=1,unaligned_padding=0.2,unaligned_image_size=(380,380),gt={}):
